...
CREATE OR REPLACE VIEW public.v_migrated_appointments
 ...
 SELECT o.source_datasetid,
    ...
    pro.provider_id,
    pro.sourceinstanceid AS provider_source_instanceid,
   ...
   FROM (((v_migrated_objects o
     ...
     LEFT JOIN v_migrated_providers pro ON ((pro.sourceinstanceid = btrim((((o.sources -> 1) -> 'instanceId'::text))::text, '"'::text))))
