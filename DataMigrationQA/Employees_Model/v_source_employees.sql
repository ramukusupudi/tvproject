-- View: public.v_source_employees

-- DROP VIEW public.v_source_employees;

CREATE OR REPLACE VIEW public.v_source_employees
 AS
 SELECT employees.uid,
    ...
    provider_ids.id,
    provider_ids.scope,
    ( SELECT array_agg(provider_ids_1.id) AS array_agg
    ...
    ( SELECT array_agg(provider_ids_1.scope) AS array_agg
           FROM provider_ids provider_ids_1
...
ALTER TABLE public.v_source_employees
    OWNER TO postgres;
