...
CROSS JOIN LATERAL (VALUES
	...
	('provider_uid', source.provider::text, source.provider, 'provider_source_instanceid', target.source_provider_id::text, null),
  ...
  ('type', source.type, case
       ...
       when source.type = '27' THEN 'Other'
       ...
       when source.type = '35' THEN 'Other'
       when source.type = '36' THEN 'Other'
       ...
       when source.type = '41' THEN 'Other'
       when source.type = '42' THEN 'Other'
       when source.type = '43' THEN 'Other'
   	   when source.type = '44' THEN 'Other'
   	   when source.type = '45' THEN 'Other'
       when source.type = '46' THEN 'Other'
       when source.type = '47' THEN 'Other'
	   when source.type = '48' THEN 'Preop / Enhancement'
       when source.type = '49' THEN 'Other'
       ...
       when source.type = '55' THEN 'Other'
       when source.type = '56' THEN 'Other'
	   when source.type = '57' THEN 'MEPCOM Consultation'
       when source.type = '58' THEN 'Other'
       when source.type = '59' THEN 'Other'
       when source.type = '60' THEN 'Other'
       ...
       when source.type = '83' THEN 'Other'
       when source.type = '84' THEN 'Other'
	   when source.type = '85' THEN 'Glasses Consultation'
	   when source.type = '86' THEN 'Corneal Refractive Therapy Eval (CRT)'
       when source.type = '87' THEN 'Other'
       when source.type = '88' THEN 'Other'
       when source.type = '89' THEN 'Other'
     end::text,
