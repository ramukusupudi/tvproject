...
--select * FROM source_target_match WHERE  source_datasetId = 'pupil' and matched ='FALSE' and target_value is not null
...
('pupils',source.pupils,case when source.pupils = '/null/' THEN ''
                             ...
                             when source.pupils is not null THEN REPLACE(source.pupils,'\\n','\n')
